...
<head>
  ...
  <title id="vp-page-title">${msg("loginTitle")} · Virtuoso NetSoft</title>
  <link rel="icon" id="vp-favicon" href="${url.resourcesPath}/img/virtuoso-favicon.ico" />
...
<body class="vp-body ${bodyClass}"
  ...
  <script>
    (function () {
      // Virtuoso: pin Keycloak login to light theme.
